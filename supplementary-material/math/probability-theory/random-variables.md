...
<figure><img src="../../../.gitbook/assets/image (2) (1) (1) (1).png" alt=""><figcaption><p>Flipping ten thousand coins and tracking the result. The <span class="math">x</span> axis is the number of repetitions, the <span class="math">y</span> axis is the difference between heads and tails over the number of repetitions. We see that while the paths start very differently, they converge very quickly to <span class="math">0</span>.</p></figcaption></figure>
